...
class Generator {
  constructor (chain, k, startWords) {
    this._chain = chain;
  ...
  addWords(words){ this._startWords = this._startWords.concat(...words); }
  setStartWords(words){ this._startWords = words; }
